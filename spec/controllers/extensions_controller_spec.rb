...
RSpec.describe ExtensionsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested extension as @extension" do
      ...
      expect(assigns(:extension)).to eq(extension)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created extension as @extension" do
        post :create, {:extension => valid_attributes}, valid_session
        expect(assigns(:extension)).to be_a(Extension)
        expect(assigns(:extension)).to be_persisted
      end

      it "redirects to the created extension" do
        post :create, {:extension => valid_attributes}, valid_session
        expect(response).to redirect_to(Extension.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved extension as @extension" do
        post :create, {:extension => invalid_attributes}, valid_session
        expect(assigns(:extension)).to be_a_new(Extension)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested extension" do
        extension = Extension.create! valid_attributes
        put :update, {:id => extension.to_param, :extension => new_attributes}, valid_session
        extension.reload
    ...
    describe "with invalid params" do
      it "assigns the extension as @extension" do
        extension = Extension.create! valid_attributes
        put :update, {:id => extension.to_param, :extension => invalid_attributes}, valid_session
        expect(assigns(:extension)).to eq(extension)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the extensions list" do
      extension = Extension.create! valid_attributes
      delete :destroy, {:id => extension.to_param}, valid_session
      expect(response).to redirect_to(extensions_url)
    end
  end
